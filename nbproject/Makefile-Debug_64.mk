...
${OBJECTDIR}/src/SGIEngine/ColladaLoader.o: src/SGIEngine/ColladaLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/ColladaLoader.o src/SGIEngine/ColladaLoader.cpp
...
${OBJECTDIR}/src/SGIEngine/IndexVector.o: src/SGIEngine/IndexVector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/IndexVector.o src/SGIEngine/IndexVector.cpp
...
${OBJECTDIR}/src/SGIEngine/PropModule.o: src/SGIEngine/PropModule.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/PropModule.o src/SGIEngine/PropModule.cpp
