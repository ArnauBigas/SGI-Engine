...
${OBJECTDIR}/src/SGIEngine/AudioData.o: src/SGIEngine/AudioData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/AudioData.o src/SGIEngine/AudioData.cpp

${OBJECTDIR}/src/SGIEngine/AudioEngine.o: src/SGIEngine/AudioEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/AudioEngine.o src/SGIEngine/AudioEngine.cpp

${OBJECTDIR}/src/SGIEngine/AudioObject.o: src/SGIEngine/AudioObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/AudioObject.o src/SGIEngine/AudioObject.cpp
...
${OBJECTDIR}/src/SGIEngine/Game.o: src/SGIEngine/Game.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Game.o src/SGIEngine/Game.cpp

${OBJECTDIR}/src/SGIEngine/Gui.o: src/SGIEngine/Gui.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Gui.o src/SGIEngine/Gui.cpp

${OBJECTDIR}/src/SGIEngine/GuiElement.o: src/SGIEngine/GuiElement.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/GuiElement.o src/SGIEngine/GuiElement.cpp
...
${OBJECTDIR}/src/SGIEngine/Label.o: src/SGIEngine/Label.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Label.o src/SGIEngine/Label.cpp

${OBJECTDIR}/src/SGIEngine/Light.o: src/SGIEngine/Light.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Light.o src/SGIEngine/Light.cpp

${OBJECTDIR}/src/SGIEngine/LightEmitterModule.o: src/SGIEngine/LightEmitterModule.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/LightEmitterModule.o src/SGIEngine/LightEmitterModule.cpp

${OBJECTDIR}/src/SGIEngine/LoadingState.o: src/SGIEngine/LoadingState.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/LoadingState.o src/SGIEngine/LoadingState.cpp
...
${OBJECTDIR}/src/SGIEngine/PositionalAudioObject.o: src/SGIEngine/PositionalAudioObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/PositionalAudioObject.o src/SGIEngine/PositionalAudioObject.cpp
...
${OBJECTDIR}/src/SGIEngine/RenderEngine.o: src/SGIEngine/RenderEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/RenderEngine.o src/SGIEngine/RenderEngine.cpp

${OBJECTDIR}/src/SGIEngine/ResourceEngine.o: src/SGIEngine/ResourceEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/ResourceEngine.o src/SGIEngine/ResourceEngine.cpp

${OBJECTDIR}/src/SGIEngine/Shader.o: src/SGIEngine/Shader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Shader.o src/SGIEngine/Shader.cpp

${OBJECTDIR}/src/SGIEngine/SoundEmitterModule.o: src/SGIEngine/SoundEmitterModule.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/SoundEmitterModule.o src/SGIEngine/SoundEmitterModule.cpp

${OBJECTDIR}/src/SGIEngine/SphereCollider.o: src/SGIEngine/SphereCollider.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/SphereCollider.o src/SGIEngine/SphereCollider.cpp

${OBJECTDIR}/src/SGIEngine/TaskEngine.o: src/SGIEngine/TaskEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/TaskEngine.o src/SGIEngine/TaskEngine.cpp

${OBJECTDIR}/src/SGIEngine/Terrain.o: src/SGIEngine/Terrain.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Terrain.o src/SGIEngine/Terrain.cpp

${OBJECTDIR}/src/SGIEngine/Texture.o: src/SGIEngine/Texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Texture.o src/SGIEngine/Texture.cpp

${OBJECTDIR}/src/SGIEngine/TexturedGuiQuad.o: src/SGIEngine/TexturedGuiQuad.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/TexturedGuiQuad.o src/SGIEngine/TexturedGuiQuad.cpp

${OBJECTDIR}/src/SGIEngine/Timer.o: src/SGIEngine/Timer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Timer.o src/SGIEngine/Timer.cpp

${OBJECTDIR}/src/SGIEngine/Utility.o: src/SGIEngine/Utility.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Utility.o src/SGIEngine/Utility.cpp

${OBJECTDIR}/src/SGIEngine/Wall.o: src/SGIEngine/Wall.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/Wall.o src/SGIEngine/Wall.cpp
...
${OBJECTDIR}/src/SGIEngine/WorldState.o: src/SGIEngine/WorldState.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/SGIEngine
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SGIEngine/WorldState.o src/SGIEngine/WorldState.cpp
